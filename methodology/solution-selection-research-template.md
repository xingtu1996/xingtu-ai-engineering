***REMOVED*** 方法模板：方案选型调研（Solution Research / Technology Selection）— 多源对比，选能落地方案

***REMOVED******REMOVED*** 一、定义
...
***REMOVED******REMOVED*** 三、调研文档骨架（对齐 research README 规范：一句话结论/调研发现/决策/来源/关联）
