...
***REMOVED*** 方法-SDD（Spec-Driven Development）
...
***REMOVED******REMOVED******REMOVED*** No Spec, No Code 门禁细则（constitution 铁律 1 + specs-rules 铁律 1）
