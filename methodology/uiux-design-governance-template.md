***REMOVED*** 方法-UIUX设计管控（UIUX Governance / Design Token）
...
***REMOVED******REMOVED*** 二、Design Token 骨架（引用示例企业金黑）

```css
:root {
  --brand-gold: ***REMOVED***CDAE7C;  --brand-black: ***REMOVED***221F20;
  --primary: var(--brand-black);  --primary-text: var(--brand-gold);
  --text: rgba(0,0,0,.65);  --text-strong: rgba(0,0,0,.85);
  --border: ***REMOVED***d9d9d9;  --border-split: ***REMOVED***e8e8e8;
  --success: ***REMOVED***52c41a;  --warning: ***REMOVED***faad14;  --error: ***REMOVED***ff4d4f;
...
| 主按钮 | 金字 ***REMOVED***CDAE7C + 曜黑底 ***REMOVED***221F20，hover ***REMOVED***2E2B2C |
| 表格 | 表头 ***REMOVED***fafafa、行线 ***REMOVED***e8e8e8、hover ***REMOVED***e6f7ff、激活分页金色 |
| 字体 | Microsoft YaHei / PingFang SC，不用外链字体 |

***REMOVED******REMOVED*** 四、UX 交互与可用性
...
***REMOVED******REMOVED*** 五、反 AI 味检查（frontend-design）

□ 先定审美（品牌金黑），不套模板默认 □ 禁蓝紫渐变/三等卡片/Inter 字体
□ 主色非 ***REMOVED***1890ff，激活态金色 □ 圆角 4px（非 8/16 AI 味）

***REMOVED******REMOVED*** 六、示例企业实践对应
