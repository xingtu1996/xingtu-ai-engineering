***REMOVED*** Ponytail & Caveman — 开源 AI 编码精简工具（分享介绍）
...
***REMOVED******REMOVED*** GitHub + Star + License
...
***REMOVED******REMOVED******REMOVED*** ponytail（生成层：最少代码）
```
/ponytail            全量（默认）
...
***REMOVED******REMOVED******REMOVED*** caveman（散文层：精简输出）
```
/caveman             全量（默认）
...
***REMOVED*** Codex / 其他 agent
npx skills add DietrichGebert/ponytail
npx skills add JuliusBrussee/caveman
```

***REMOVED******REMOVED*** 示例企业实践（验证）
